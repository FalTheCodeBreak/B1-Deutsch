...
document.getElementById('menuButton').onclick = function(event) {
    ...
    toggleDropdown('dropdownMenu', 'dropdownMenu1');
};

document.getElementById('menuButton1').onclick = function(event) {
    event.stopPropagation(); // Mencegah event bubbling
    toggleDropdown('dropdownMenu1', 'dropdownMenu');
};

function toggleDropdown(currentDropdownId, otherDropdownId) {
    var currentDropdown = document.getElementById(currentDropdownId);
    var otherDropdown = document.getElementById(otherDropdownId);

    // Jika dropdown saat ini sudah terbuka, tutup
    if (currentDropdown.style.display === 'block') {
        currentDropdown.style.display = 'none';
    } else {
        // Tutup dropdown lainnya dan buka dropdown saat ini
